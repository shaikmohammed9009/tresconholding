      ...
      >
        {differentiators.map((item, index) => (
          <motion.div
            ...
            className="flex md:flex items-center  flex-col md:flex-row  space-x-4"
          >
            ...
            <div>
              <h3 
                id={item.id}
                className="font-['Anek_Devanagari'] text-[20px] md:text-[22px] mt-3 font-[500] leading-[28.6px] text-center sm:text-left text-[#01373D] mb-2"
                style={{ 
                  textUnderlinePosition: 'from-font',
                  textDecorationSkipInk: 'none'
                }}
